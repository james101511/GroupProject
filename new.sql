...
(
    ...
    FOREIGN KEY (project_name) REFERENCES project(project_name) ON UPDATE CASCADE
);
create table task
(
	task_name varchar(255) , project_name varchar(255),start_date varchar(255),end_date varchar(255),task_progress varchar(255)
);
